...
class CmdVelListener(Node):
    """ROS2 node to listen to /cmd_vel."""
    def __init__(self):
        super().__init__("teleop_rsl_rl")
    ...
    def cmd_vel_callback(self, msg):
        self.cmd_vel_linear_x = msg.linear.x
        self.cmd_vel_linear_y = msg.linear.y
        self.cmd_vel_angular_z = msg.angular.z
...
def main():
    ...
    infos = {"observations": obs_dict["observations"]}  # 초기화
