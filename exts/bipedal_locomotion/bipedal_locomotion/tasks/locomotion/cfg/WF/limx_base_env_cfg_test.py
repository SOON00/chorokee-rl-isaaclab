...
class WFSceneCfg(InteractiveSceneCfg):
    ...
    contact_forces = ContactSensorCfg(
        prim_path="{ENV_REGEX_NS}/Robot/Left_.*|Right_.*", history_length=4, track_air_time=True, update_period=0.0
    )
...
class ActionsCfg:
    ...
    joint_vel = mdp.JointVelocityActionCfg(
        asset_name="robot",
        joint_names=["Left_wheel_pitch_joint", "Right_wheel_pitch_joint"],
        scale = 0.5, # 10
    )
...
class ObservarionsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        joint_pos = ObsTerm(func=mdp.joint_pos_rel_exclude_wheel,
                            params={"wheel_joints_name": ["Left_wheel_pitch_joint", "Right_wheel_pitch_joint"]}, 
    ...
    class CriticCfg(ObsGroup):
        ...
        feet_lin_vel = ObsTerm(
            func=mdp.feet_lin_vel, params={"asset_cfg": SceneEntityCfg("robot", body_names="Left_wheel_link|Right_wheel_link")}
        )
        ...
        feet_contact_force = ObsTerm(
            func=mdp.robot_contact_force, params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names="Left_wheel_link|Right_wheel_link")}
        )
...
class EventsCfg:
    ...
    add_link_mass = EventTerm(
        ...
        mode="startup",
        params={
            "asset_cfg": SceneEntityCfg("robot", body_names="Left_hip_link|Right_hip_link|Left_thigh_link|Right_thigh_link|Left_calf_link|Right_calf_link"),
...
class RewardsCfg:
    ...
    rew_leg_symmetry = RewTerm(
        ...
        weight=0.5,
        params={"asset_cfg": SceneEntityCfg("robot", body_names="Left_wheel_link|Right_wheel_link"), "std": math.sqrt(0.5)},
    )
    rew_same_foot_x_position = RewTerm(
        func=mdp.same_feet_x_position,
        weight=-50, # 0.1, # changed to penalty mode
        params={"asset_cfg": SceneEntityCfg("robot", body_names="Left_wheel_link|Right_wheel_link")},
    )
    ...
    pen_non_wheel_pos_limits = RewTerm(
        ...
        weight=-2.0,
        params={"asset_cfg": SceneEntityCfg("robot", joint_names="Left_hip_yaw_joint|Right_hip_yaw_joint|Left_hip_pitch_joint|Right_hip_pitch_joint|Left_knee_pitch_joint|Right_knee_pitch_joint")},
    )
    undesired_contacts = RewTerm(
        func=mdp.undesired_contacts,
        weight=-0.25,
        params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names=["Left_hip_yaw_joint|Right_hip_yaw_joint|Left_hip_pitch_joint|Right_hip_pitch_joint|Left_knee_pitch_joint|Right_knee_pitch_joint|base_link"]), "threshold": 10.0},
    )
    ...
    pen_feet_distance = RewTerm(
        ...
        params={"min_feet_distance": 0.32,
                ...
                "feet_links_name": ["Left_wheel_link", "Right_wheel_link"]}
    )
    ...
    pen_joint_vel_wheel_l2 = RewTerm(
        func=mdp.joint_vel_l2, weight=-5e-3, params={"asset_cfg": SceneEntityCfg("robot", joint_names="Left_wheel_link|Right_wheel_link")}
    )
