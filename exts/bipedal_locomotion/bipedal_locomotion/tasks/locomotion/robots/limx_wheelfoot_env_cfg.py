...
class WFBaseEnvCfg(WFEnvCfg):
    def __post_init__(self):
        ...
        self.commands.base_height = UniformHeightCommandCfg(asset_name="robot")
        
        from bipedal_locomotion.tasks.locomotion.mdp.actions.height_actions import HeightAwareJointPositionActionCfg

        self.actions.joint_pos = HeightAwareJointPositionActionCfg(
            asset_name="robot",  
